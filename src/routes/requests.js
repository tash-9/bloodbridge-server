...
// GET /api/requests/public  — all pending (no auth required)
...
// GET /api/requests — paginated, filtered
router.get("/", verifyToken, async (req, res) => {
  try {
    ...
    // Donors only see their own; admins/volunteers see all unless ?mine=true
...
// PATCH /api/requests/:id — edit fields
